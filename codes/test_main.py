...
def run_HumLa(project_id=4, n_test=5505, seeds=range(1), verbose_int=0, is_plot=False):
    ...
    for ss, seed in enumerate(seeds):
        ...
        for tt in range(nb_test_act):
            ...
            if test_y_pre[tt] == 1:
                ...
                pre_commit_id = test_commit.iloc[test_step]['pre-commit-id']
                commit_id = test_commit.iloc[test_step]['commit-id']
